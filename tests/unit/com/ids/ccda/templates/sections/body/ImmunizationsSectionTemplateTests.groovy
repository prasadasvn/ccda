...
public class ImmunizationsSectionTemplateTests {
    ...
    void setUp() {
        ...
        document = new Document( docUid, [immunizations:TEST_MAP])
    }

    @Test
    void testSomething() {
        template = new ImmunizationsSectionTemplate(document).builder
        document.display()
        assertTrue(true)
    }
}
