 ...
 */
public abstract class IDSBuilderSupport extends GroovyObjectSupport {

    private Object current;
    private Closure nameMappingClosure;
    private final IDSBuilderSupport proxyBuilder;

    public IDSBuilderSupport() {
        this.proxyBuilder = this;
    }

    public IDSBuilderSupport(IDSBuilderSupport proxyBuilder) {
        this(null, proxyBuilder);
    }

    public IDSBuilderSupport(Closure nameMappingClosure, IDSBuilderSupport proxyBuilder) {
    ...
    public Object invokeMethod(String methodName) {
        System.out.println("Called first invokeMethod");
        return invokeMethod(methodName, null);
    }

    public Object invokeMethod(String methodName, Object args) {
        System.out.println("Called second invokeMethod");
    ...
    protected Object doInvokeMethod(String methodName, Object name, Object args) {
        ...
        System.out.println("Called invokeMethod for methodName:" + methodName + " with name: " + name + " arguments: " + list + ", list.size():" + list.size());
        ...
        switch (list.size()) {
            ...
            case 1: {
                ...
                System.out.println("type of Map:" + object.getClass() );
