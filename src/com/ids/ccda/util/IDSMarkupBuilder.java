 ...
 * @author Paul King
 * @version $Revision: 21453 $
 */
public class IDSMarkupBuilder extends IDSBuilderSupport {
     ...
     * @see IndentPrinter#IndentPrinter(java.io.Writer)
     */
    public IDSMarkupBuilder(PrintWriter pw) {
     ...
     * @see IndentPrinter#IndentPrinter(java.io.Writer)
     */
    public IDSMarkupBuilder(Writer writer) {
     ...
     */
    public IDSMarkupBuilder(IndentPrinter out) {
        this.out = out;
    }
     ...
     * helper methods, namely {@link groovy.xml.MarkupBuilderHelper#yield(String)},
     * {@link groovy.xml.MarkupBuilderHelper#yieldUnescaped(String)},
     * {@link groovy.xml.MarkupBuilderHelper#pi(java.util.Map)},
     * {@link groovy.xml.MarkupBuilderHelper#xmlDeclaration(java.util.Map)} and
     * {@link groovy.xml.MarkupBuilderHelper#comment(String)}.
     *
     * @return this MarkupBuilder
     */
    public Object getMkp() {
        return new IDSMarkupBuilderHelper(this);
    }
